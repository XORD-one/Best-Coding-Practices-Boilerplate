...
import type { DaoEventsV2, DaoEventsV2Interface } from "../DaoEventsV2";
...
export class DaoEventsV2__factory {
  static readonly abi = _abi;
  static createInterface(): DaoEventsV2Interface {
    return new utils.Interface(_abi) as DaoEventsV2Interface;
  }
  static connect(
    address: string,
